...
const browserstackBrowsers = {
  ...
  OSXCatalina_FirefoxLatest: { os: 'OS X', os_version: 'Catalina', browser: 'Firefox', browser_version: 'latest-beta' },
  // OSXCatalina_FirefoxLatest_Incognito: { os: 'OS X', os_version: 'Catalina', browser: 'Firefox', browser_version: 'latest-beta, ...firefoxIncognitoCapabilities },
  OSXCatalina_EdgeLatest: { os: 'OS X', os_version: 'Catalina', browser: 'Edge', browser_version: 'latest-beta' },
