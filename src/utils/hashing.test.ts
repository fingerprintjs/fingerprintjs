...
const longText = 'Sociosqu libero in, gravida curae lobortis imperdiet. Elit odio consequat magna, molestie' +
  'adipiscing phasellus, scelerisque urna integer id ad quam sit etiam. Etiam fringilla sodales, rhoncus imperdiet ' +
  'viverra ultricies congue. Porttitor etiam, nam a imperdiet. Leo himenaeos, mattis vitae senectus. Imperdiet ' +
  'convallis, congue sem tortor nulla. Lacus non conubia, hendrerit quisque, class lorem primis elit curabitur morbi ' +
  'felis. Hendrerit etiam tempus, accumsan urna nec torquent laoreet. Nisl tristique nibh, dictum ligula, litora ' +
  'risus vulputate porta volutpat aliquam. ' +
  'Aenean morbi convallis porttitor, nunc viverra egestas, tincidunt leo nam cubilia enim ligula rhoncus luctus. ' +
  'Porttitor fringilla suscipit, cras enim, aenean pulvinar morbi litora massa. Mollis magna facilisis orci, aptent ' +
  'justo inceptos, aliquet felis commodo turpis arcu donec class eros. Quisque fames per, ante ligula, curae ' +
  'pulvinar potenti aenean placerat. Facilisis semper fringilla scelerisque, fusce ante vulputate himenaeos ' +
  'malesuada. Ut platea, maecenas cursus ullamcorper. Nisl etiam nunc, diam tristique, dapibus metus malesuada ' +
  'scelerisque nam.' +
...
describe('Murmur3', () => {
  it('makes x64 128 bit hash', () => {
    ...
    expect(x64hash128(longText)).toBe('9995ddd20c39e741d9d60960996cd5b9')
  })
})
